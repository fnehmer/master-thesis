...
\end{figure}
\todo{Improve all graphics resolutions}
...
\section{Algorithms}
\todo{Write intro to the algorithms}
...
\todo{Write about Self-Organizing Maps}
\lipsum[1-2]
...
\todo{Add the reference to sections}
\todo{Add the table from the research}
...
\todo{Write about the related work by \cite{zhuo2017network} and \cite{nalavade2014}}
...
\section{Results}
\todo{Write text for the results}
...
\todo{Use other visualization with greyscale in mind.}
